...
% compute values of energy for wavenumber > 0.033 Km (30 Km wave length)
 ...
 ske  = sum(pf(f < 0.05 & f > 0.0066)); % beteween 150km and 20km
...
title(strcat(['KE below 150km and KE below 20km vs Time (region ',R,', high-res)']),'fontsize',16);
...
title(strcat(['KE below 150km and KE below 20km vs Time (region ',R,', low-res)']),'fontsize',16);
set(H1,'LineStyle','-','linewidth',2);
set(H2,'LineStyle','-','linewidth',2);

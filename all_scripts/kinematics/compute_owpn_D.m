...
t = title('OW^+ and OW^- vs time (region D, high res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_h_D.eps');
...
t = title('Anomalies OW^+ and OW^- vs time (region D, high res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_h_a_D.eps');
...
t = title('OW^+ and OW^- vs time (region D, low res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_l_D.eps');
...
t = title('Anomalies OW^+ and OW^- vs time (region D, low res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_l_a_D.eps');
...
t = title('OW^+ - OW^-, high and low res, vs time (region D');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_diff_D.eps');

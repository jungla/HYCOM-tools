...
t = title('OW^+ and OW^- vs time (region B, high res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_h_B.eps');
...
t = title('Anomalies OW^+ and OW^- vs time (region B, high res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_h_a_B.eps');
...
t = title('OW^+ and OW^- vs time (region B, low res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_l_B.eps');
...
t = title('Anomalies OW^+ and OW^- vs time (region B, low res)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_l_a_B.eps');
...
t = title('OW^+ - OW^-, high and low res, vs time (region B)');
set(t,'FontSize',18)
print(owml,'-dpsc2','OW+_OW-_diff_B.eps');

...
xlabel('K (km^{-1})','FontSize',18);
ylabel('KE (m^2/s^2)','FontSize',18);
...
text(4*10^-2,0.5,'-5/3','Color','r','fontsize',18);
text(1.5*10^-1,0.5,'-3','Color','r','fontsize',18);

if (arch==1)
 label = strcat('./plot/spectra_ke_h_',R,'.eps')
else
 label = strcat('./plot/spectra_ke_l_',R,'.eps')
end

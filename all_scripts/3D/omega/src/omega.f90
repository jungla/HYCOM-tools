...
integer,parameter       :: ni=1,nf=41                                                  ! # layers, # scans, projection factor
integer                 :: nt,ns,kl
...
integer                 :: X1,         X2,         Y1,        Y2
real*4                  :: r0,         dz1,       dz2,        idz1,      idz2,      idz12, sumo, sumoo
...
write(*,*) 'flag:',flag   ! use with ageostrophic velocities ('a') or geostrophic ('g', not implemented)
write(*,*) 'ns:',ns       ! number of iterations
write(*,*) 'X1',X1
write(*,*) 'X2',X2
write(*,*) 'Y1',Y1
write(*,*) 'Y2',Y2

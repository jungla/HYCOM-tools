...
FMP(itime) = avg_3D(FP,pscx,pscy,fm,depth)
FMN(itime) = avg_3D(FN,pscx,pscy,fm,depth)
...
hold on
p1 = plot(dayi:dayf,FMP,'k',dayi:dayf,FMN,'b','LineWidth',1.2);
...
filename = strcat('./plot/F_PN_',R,'.eps')

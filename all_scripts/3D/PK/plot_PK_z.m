...
%%%%%%%%%%%%%%%%  read mld %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 if (arch == 1)
  file1 = strcat('../../stratification/boundarylayer/output/high-res/boundarylayer_h_016_archv.',lyear,'_',lday,'_00.a');
 else
  file1 = strcat('../../stratification/boundarylayer/output/low-res/boundarylayer_l_016_archv.',lyear,'_',lday,'_00.a');
 end

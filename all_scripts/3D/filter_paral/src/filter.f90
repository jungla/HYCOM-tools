...
do l = 1,nl
! write(*,*) l
 call rbf(flnmr,idm,jdm,l,rt(:,:))
! call smooth2(r(:,:,l),2)
 call rbf(flnmu,idm,jdm,l,ut(:,:))
 call rbf(flnmv,idm,jdm,l,vt(:,:))
 call rbf(flnmw,idm,jdm,l,wt(:,:))
 u(:,:,l) = ut(X1:X2,Y1:Y2)
 v(:,:,l) = vt(X1:X2,Y1:Y2)
 w(:,:,l) = wt(X1:X2,Y1:Y2)
 r(:,:,l) = rt(X1:X2,Y1:Y2)

...
real*4, allocatable     :: u(:,:,:),  v(:,:,:),  w(:,:,:),  r(:,:,:), t(:,:,:)
real*4, allocatable     :: uf(:,:,:), vf(:,:,:), wf(:,:,:), rf(:,:,:), tf(:,:,:)
...
!write(*,*) r(100,100,l)
!write(*,*) rf(100,100,l)
 call sinxx(t(:,:,l),tf(:,:,l),pscx,pscy,ids,jds,lambdac,1)
write(*,*) t(100,100,l)
write(*,*) tf(100,100,l)
...
call wbf3d(flnmtf,ids,jds,nl,tf)

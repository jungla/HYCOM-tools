...
fuo = binaryread(fileuo,ids,jds,ijds,depthid);
fvo = binaryread(filevo,ids,jds,ijds,depthid);
fwo = binaryread(filewo,ids,jds,ijds,depthid);
fro = binaryread(filero,ids,jds,ijds,depthid);
...
%%%%%%%%%%%%%%%%%%%%%% filter eke
 ...
 ekef = 0.5*(fuf.^2+fvf.^2);
 eker = 0.5*(fur.^2+fvr.^2);
 ekeo = 0.5*(fuo.^2+fvo.^2);

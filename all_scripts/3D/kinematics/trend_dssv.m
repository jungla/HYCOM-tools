...
if (arch == 1)
 ...
 file1  = strcat('./output/high-res/vorticity_a_h_016_archv.',lyear,'_',lday,'_00.a');
 file2  = strcat('./output/high-res/divergence_a_h_016_archv.',lyear,'_',lday,'_00.a');
 file3  = strcat('./output/high-res/shearing_a_h_016_archv.',lyear,'_',lday,'_00.a');
 file4  = strcat('./output/high-res/stretching_a_h_016_archv.',lyear,'_',lday,'_00.a');
else
 file   = strcat('./output/low-res/okuboweiss_a_l_016_archv.',lyear,'_',lday,'_00.a');
 file1  = strcat('./output/low-res/vorticity_a_l_016_archv.',lyear,'_',lday,'_00.a');
 file2  = strcat('./output/low-res/divergence_a_l_016_archv.',lyear,'_',lday,'_00.a');
 file3  = strcat('./output/low-res/shearing_a_l_016_archv.',lyear,'_',lday,'_00.a');
 file4  = strcat('./output/low-res/stretching_a_l_016_archv.',lyear,'_',lday,'_00.a');
end
...
if arch == 1
 print(f0,'-dpsc2',strcat('./plot/dssv_h_',R,'.eps'));
else
 print(f0,'-dpsc2',strcat('./plot/dssv_l_',R,'.eps'));
end

...
if arch == 1
 day   = textread('../archivesDay_2_h_l01');
 year  = textread('../archivesYear_2_h_l01');
else
 day   = textread('../archivesDay_2_l_l01');
 year  = textread('../archivesYear_2_l_l01');
end
...
if arch == 1
 label = strcat('./plot/high-res/regions_map_lcs_h_',lyear,'_',lday,'_',hr,'.eps')
% label = strcat('./plot/regions_map_lcs_h_',digit(itime,3),'.eps')
else
 label = strcat('./plot/low-res/regions_map_lcs_l_',lyear,'_',lday,'_',hr,'.eps')

...
if (arch == 1)
 file1  = strcat('../../../GSa0.02_ML_2/016_archv.',lyear,'_',lday,'_00_ML_3zr.A');
 file2  = strcat('../../../GSa0.02_ML_2/016_archv.',lyear,'_',lday,'_00_ML_3zw.A');
else
 file1  = strcat('../../../GSa0.08_ML_2/archv.',lyear,'_',lday,'_00_ML_3zr.A');
 file2  = strcat('../../../GSa0.08_ML_2/archv.',lyear,'_',lday,'_00_ML_3zw.A');
end

Rhot = binaryread(file1,idm,jdm,ijdm,did);
wt   = binaryread(file2,idm,jdm,ijdm,did);
...
if (arch == 1)
 label = strcat('./plot/high-res/w_ML_',depth,'_',lyear,'_',lday,'_h_',R,'.eps')
else
 label = strcat('./plot/low-res/w_ML_',depth,'_',lyear,'_',lday,'_l_',R,'.eps')
end 

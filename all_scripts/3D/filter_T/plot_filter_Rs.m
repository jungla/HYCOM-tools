...
if (arch == 1)
 fileu   = strcat('/tamay/mensa/hycom/scripts/3D/filter/output/high-res/filter_A_h_016_archv.',lyear,'_',lday,'_00_u.a');
 fileuo   = strcat('/tamay/mensa/hycom/GSa0.02_3D/016_archv.',lyear,'_',lday,'_00_3zu.A');
 filev   = strcat('/tamay/mensa/hycom/scripts/3D/filter/output/high-res/filter_A_h_016_archv.',lyear,'_',lday,'_00_v.a');
...
ftuf = binaryread(fileu,idm,jdm,ijdm,depthid);
ftvf = binaryread(filev,idm,jdm,ijdm,depthid);
ftwf = binaryread(filew,idm,jdm,ijdm,depthid);
ftrf = binaryread(filer,idm,jdm,ijdm,depthid);

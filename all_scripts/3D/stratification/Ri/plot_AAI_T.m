...
if (arch == 1)
 file0  = strcat('../../../3D/kinematics/output/dssv/high-res/shearing_h_016_archv.',lyear,'_',lday,'_',depth,'_00.a');
 file1  = strcat('../../../3D/kinematics/output/dssv/high-res/stretching_h_016_archv.',lyear,'_',lday,'_',depth,'_00.a');
 ...
 file0  = strcat('../../../3D/kinematics/output/dssv/low-res/shearing_l_016_archv.',lyear,'_',lday,'_',depth,'_00.a');
 file1  = strcat('../../../3D/kinematics/output/dssv/low-res/stretching_l_016_archv.',lyear,'_',lday,'_',depth,'_00.a');
...
% set(p1,'Color',[0 0 0]);
 ...
 set(r0,'Color',[0 0 0],'LineWidth',1.2,'LineStyle','-','ShowText','off');

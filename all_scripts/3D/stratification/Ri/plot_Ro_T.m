...
% file1  = strcat('/media/sdd1/hycom/GSa0.02_3D/016_archv.',lyear,'_',lday,'_00_3zr.A');
 file2  = strcat('../../kinematics/output/dssv/high-res/vorticity_h_016_archv.',lyear,'_',lday,'_',depth,'_',R,'_00.a');
else
% file1  = strcat('/media/sdd1/hycom/GSa0.08_3D/archv.',lyear,'_',lday,'_00_3zr.A');
 file2  = strcat('../../kinematics/output/dssv/low-res/vorticity_l_016_archv.',lyear,'_',lday,'_',depth,'_',R,'_00.a');
end

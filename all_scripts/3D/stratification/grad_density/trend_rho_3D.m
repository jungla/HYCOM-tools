...
depthid_ML = str2num(readline('/tamay/mensa/hycom/scripts/3D/layersDepthID_all_02',did));
depth_ML = str2num(readline('/tamay/mensa/hycom/scripts/3D/layersDepth_all_02',did));
...
% set(p2,'LineStyle','--')
 ...
 label = strcat('./plot/Rho_',R,'_3D.eps')

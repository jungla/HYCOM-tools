...
if (arch == 1)
 label = strcat('./plot/',num2str(dmax),'/high-res/dens_',num2str(dmax),'_',liyear,'_',liday,'_h_',R,'_',num2str(l1),'_s.eps')
else
 label = strcat('./plot/',num2str(dmax),'/low-res/dens_',num2str(dmax),'_',liyear,'_',liday,'_l_',R,'_',num2str(l1),'_s.eps')
end

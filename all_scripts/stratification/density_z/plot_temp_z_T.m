...
if (arch == 1)
 label = strcat('./plot/',num2str(dmax),'/high-res/temp_z_',num2str(dmax),'_',liyear,'_',liday,'_h_',R,'_',num2str(l1),'.eps')
else
 label = strcat('./plot/',num2str(dmax),'/low-res/temp_z_',num2str(dmax),'_',liyear,'_',liday,'_l_',R,'_',num2str(l1),'.eps')
end
